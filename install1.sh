...
load_language() {
    ...
    1)
        ...
        msg_cli_main_missing="TCMinerSystem is not installed. Please choose 1 to install TCMinerSystem first, then install the CLI tool."
        ...
        msg_cli_install_done_run="Run tcminer to open the CLI tool. Use tcminer start, tcminer stop, or tcminer restart to control TCMinerSystem."
        ...
        msg_cli_install_warning_title="Before installing the CLI tool, TCMinerSystem WEB access must be disabled."
        ...
        msg_web_ui_change_notice_title="Changing WEB access will restart TCMinerSystem."
        ...
        msg_web_ui_change_continue="1. Continue and restart TCMinerSystem"
    ...
    2)
        ...
        msg_cli_main_missing="TCMinerSystem 尚未安装，请先选择 1 安装 TCMinerSystem，再安装命令行工具。"
        ...
        msg_cli_install_done_run="运行 tcminer 命令即可打开命令行工具；运行 tcminer start、tcminer stop、tcminer restart 可启动、停止、重启 TCMinerSystem。"
        msg_cli_install_done_path="命令行工具路径"
        msg_cli_install_done_link="命令启动脚本"
        msg_cli_install_done_doc="命令行工具说明/使用文档"
        msg_cli_install_warning_title="安装命令行工具前，需要关闭 TCMinerSystem 的 WEB 访问。"
        ...
        msg_web_ui_change_notice_title="开启或关闭 WEB 访问会重启 TCMinerSystem。"
        msg_web_ui_change_notice_detail="关闭 WEB 访问后，网页端将不可访问；可使用 tcminer 命令行工具访问统计数据。如需安装命令行工具，请在本安装脚本菜单中选择安装命令行工具。"
        msg_web_ui_change_continue="1. 继续并重启 TCMinerSystem"
...
create_cli_launcher() {
    ...
    if [ "$lang_choice" = "2" ]; then
        ...
        text_cli_missing="未找到 TCMinerSystem CLI，请重新安装命令行工具。"
        text_cli_requires_web_disabled="命令行工具仅在 WEB 访问关闭时可用。请先运行安装脚本并选择关闭 WEB 访问。"
        text_already_running="TCMinerSystem 已在运行。"
        text_started="TCMinerSystem 已启动。"
        text_start_failed="TCMinerSystem 启动失败。"
        text_not_running="TCMinerSystem 未运行。"
        ...
        text_stop_timeout="TCMinerSystem stop timeout."
    fi
...
show_runtime_status() {
    ...
    if [ "$lang_choice" = "2" ]; then
        ...
        label_title="TCMinerSystem Runtime Status"
        label_basic="Basic"
