...
CLI_EXEC_NAME="TCMinerSystemCLI-0.1.0"
CLI_COMMAND_NAME="tcminer"
CLI_LINK_PATH="/usr/local/bin/${CLI_COMMAND_NAME}"
CLI_LAUNCHER_MARKER="Generated by TCMinerSystem install.sh"
CONFIG_FILE_NAME="rust-config"
SYSCTL_TAG="${APP_ID}"
INSTALL_DIR_GUARD="rustminersystem"
...
load_language() {
    ...
    1)
		...
		msg_website="Official Site：https://www.tcminerproxy.com"
        ...
        msg_cli_main_missing="TCMinerProxy is not installed. Please choose 1 to install TCMinerProxy first, then install the CLI tool."
        msg_cli_already_installed="tcminer CLI is already installed."
        msg_cli_command_exists="tcminer command already exists and is not managed by this script"
        msg_cli_install_done_title="CLI tool installed successfully"
        msg_cli_install_done_run="Run tcminer to open the CLI tool. Use tcminer start, tcminer stop, or tcminer restart to control TCMinerProxy."
        ...
        msg_cli_install_warning_title="Before installing the CLI tool, TCMinerProxy WEB access must be disabled."
        ...
        msg_cli_not_installed="tcminer CLI is not installed."
        msg_cli_uninstall_done="CLI tool uninstalled"
        msg_web_ui_change_notice_title="Changing WEB access will restart TCMinerProxy."
        msg_web_ui_change_notice_detail="If WEB access is disabled, the web page will be unreachable; use the tcminer CLI to access statistics. If the CLI is not installed, install it from this script's menu."
        msg_web_ui_change_continue="1. Continue and restart TCMinerProxy"
        ...
        msg_web_ui_disabled_start_tip="WEB access is disabled. Run tcminer to open the CLI tool, or enable WEB access from this install script."
    ...
    2)
		...
		msg_website="官方网站：https://www.tcminerproxy.com"
        ...
        msg_cli_main_missing="TCMinerProxy 尚未安装，请先选择 1 安装 TCMinerProxy，再安装命令行工具。"
        msg_cli_already_installed="tcminer 命令行工具已安装。"
        msg_cli_command_exists="tcminer 命令已存在，且不是由此脚本管理"
        msg_cli_install_done_title="命令行工具安装成功"
        msg_cli_install_done_run="运行 tcminer 命令即可打开命令行工具；运行 tcminer start、tcminer stop、tcminer restart 可启动、停止、重启 TCMinerProxy。"
        msg_cli_install_done_path="命令行工具路径"
        msg_cli_install_done_link="命令启动脚本"
        msg_cli_install_done_doc="命令行工具说明/使用文档"
        msg_cli_install_warning_title="安装命令行工具前，需要关闭 TCMinerProxy 的 WEB 访问。"
        ...
        msg_cli_not_installed="tcminer 命令行工具未安装。"
        msg_cli_uninstall_done="命令行工具已卸载"
        msg_web_ui_change_notice_title="开启或关闭 WEB 访问会重启 TCMinerProxy。"
        msg_web_ui_change_notice_detail="关闭 WEB 访问后，网页端将不可访问；可使用 tcminer 命令行工具访问统计数据。如需安装命令行工具，请在本安装脚本菜单中选择安装命令行工具。"
        msg_web_ui_change_continue="1. 继续并重启 TCMinerProxy"
        ...
        msg_web_ui_disabled_start_tip="当前 WEB 访问已关闭。运行 tcminer 可打开命令行工具，如需网页访问请在安装脚本中开启 WEB 访问。"
...
show_start_success() {
	...
	echo -e "${BOLD}${GREEN}${msg_other2}${RESET}"
    echo "|----------------------------------------------------------------|"
}
...
create_cli_launcher() {
    ...
    if [ "$lang_choice" = "2" ]; then
        ...
        text_app_missing="未找到 TCMinerProxy 主程序，请先完成安装。"
        text_cli_missing="未找到 TCMinerProxy CLI，请重新安装命令行工具。"
        text_cli_requires_web_disabled="命令行工具仅在 WEB 访问关闭时可用。请先运行安装脚本并选择关闭 WEB 访问。"
        text_already_running="TCMinerProxy 已在运行。"
        text_started="TCMinerProxy 已启动。"
        text_start_failed="TCMinerProxy 启动失败。"
        text_not_running="TCMinerProxy 未运行。"
        text_stopped="TCMinerProxy 已停止。"
        text_stop_timeout="TCMinerProxy 停止超时。"
    else
        ...
        text_app_missing="TCMinerProxy is not installed. Please install it first."
        text_cli_missing="TCMinerProxy CLI was not found. Please reinstall the CLI tool."
        ...
        text_already_running="TCMinerProxy is already running."
        text_started="TCMinerProxystarted."
        text_start_failed="TCMinerProxy start failed."
        text_not_running="TCMinerProxy is not running."
        text_stopped="TCMinerProxy stopped."
        text_stop_timeout="TCMinerProxy stop timeout."
    fi
...
show_cli_install_success() {
    ...
    echo -e "${msg_cli_install_done_doc}: ${BOLD}${GREEN}https://tcminerproxy.com/zh/document/tcminersystem-cli${RESET}"
...
show_runtime_status() {
    ...
    if [ "$lang_choice" = "2" ]; then
        ...
        label_title="TTCMinerProxy Runtime Status"
        label_basic="Basic"
